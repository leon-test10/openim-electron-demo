// Renderer-side structural mirror of the environment-neutral agent-core session
// contract. Keep this file type-only so renderer builds never load Electron main
// process modules at runtime.
