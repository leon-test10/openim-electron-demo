...
export const DEFAULT_AGENT_TERMINAL_PROMPT_TEMPLATE = [
  ...
  "{finalAnswerPath}",
  "",
  "List created single files under ## Output Files and whole directories under ## Output Folders in final_answer.md.",
  "",
  "Then update:",
  "{manifestPath}",
  "",
...
const buildFinalAnswerSkill = () =>
  [
    ...
    "If the user should receive an entire directory, list only the directory under ## Output Folders.",
    "Do not also list that directory's child files under ## Output Files.",
    "If both are present, Output Folders takes priority and child files are ignored.",
    ...
    "",
    "These files and folders will be automatically attached when the answer is sent to the IM conversation.",
    "",
